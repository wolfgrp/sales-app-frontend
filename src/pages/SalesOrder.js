// 📄 /frontend/src/pages/SalesOrder.jsx
...
const SalesOrder = () => {
  ...
  const [items, setItems] = useState([{ name: '', quantity: '', price: '', gst: '' }]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:4000/api/orders/submit', orderData);
